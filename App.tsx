...
function App() {
  ...
  const [gameState, setGameState] = useState<GameState>({
    ...
    weapons: [
      ...
      {
        id: 'Owners Masters Job application',
        name: 'Owners Masters Job application',
        description: 'Go and get a job!!!!!',
      ...
      {
        id: 'Vivvan Dash application',
        name: 'Vivvan Dash application',
        description: 'Go and get a job Dash!!!!!!!???!',
        price: 99999999999999999999999999999999999,
        damage: 999999999999999999,
        range: 99999999999999,
        icon: 'zap'
      ...
      {
        id: 'Suleman Ahsan application',
        name: 'Suleman Ahsann application',
        description: 'Go and get a job Ahsan!!!!!!!???!!!!',
        price: 99999999999999999999999999999999999,
        damage: 999999999999999999,
        range: 99999999999999,
        icon: 'zap'
  ...
  const [users, setUsers] = useState<User[]>([
    ...
    },
    {
      ...
      role: 'CO-Owner',
      ohis: ,
      health: ,
      isAdmin: true,
      joinDate: new Date().toISOString(),
      banned: false,
      warnings: 0,
    ...
    },
    {
      ...
      role: 'Co-Owner',
      ohis: 10,000,000,000,000,000,000,
    ...
    },
    {
      ...
      role: 'Co-Owner',
      ohis: 9999999999999999999999999999999999999999,
